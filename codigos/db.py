...
#    Fecha: 07-12-2025
#    Descripción:
#        Módulo que gestiona la conexión directa con el servidor MySQL.
...
class DB:
    def __init__(self):
        self.__conexion = mysql.connector.connect(
            user='root', password='sistemAs?394857', host='127.0.0.1', database='bancoespirometria', use_pure=True)
