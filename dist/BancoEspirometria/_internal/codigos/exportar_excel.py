...
def _crear_hoja_informe(escritor, datos):
    ...
    #CALCULO ETRICAS CLAVE (añadir mas/o crer en base de datos nuevas columas con los valores ya calculados)
...
def exportar_comparacion_excel(lista_de_datos_completos, ruta_archivo):#crear hoja conjunta y una hoja por cada simu
    try:
        ...
        print(f"ERROR DETALLADO AL CREAR EXCEL (comparativo): {e}")
